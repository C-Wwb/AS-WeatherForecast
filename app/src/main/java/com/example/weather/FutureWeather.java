...
public class FutureWeather extends AppCompatActivity implements Runnable,View.OnClickListener{
    ...
    Vector<String> days=new Vector<>();//日期
    Vector<String> week=new Vector<>();//星期几
    Vector<String> citynm=new Vector<>();//城市名称
    Vector<String> tem=new Vector<>();//温度（高温/低温）
    Vector<String> weather=new Vector<>();//天气情况
    Vector<String> icon=new Vector<>();//天气图标
    Vector<String> icon1=new Vector<>();//晚间天气图标

    Vector<Bitmap> bitmap=new Vector<>();
    Vector<String> wind=new Vector<>();//风向
    Vector<String> winp=new Vector<>();//风力
    //Vector<String> tem_high=new Vector<>();//最高温
    //Vector<String> tem_low=new Vector<>();//最低温
    String city="beijing";
    ...
    public void findViews(){
        ...
        main=findViewById(R.id.future_main);
    }
    ...
    public void parseData(){
        ...
        try{
            ...
            tInputStringStream=new ByteArrayInputStream(resultData.toString().getBytes());
    ...
    public void showData(){
        ...
        if(days.size()==0){
            ...
            cityView.setTextSize(15);
            cityView.setTextColor(getResources().getColor(R.color.design_default_color_on_secondary));
            ...
            for(int i=0;i<days.size();i++) {
              ...
              /*  TextView cityView = new TextView(this);
                ...
                daysView.setTextColor(getResources().getColor(R.color.design_default_color_on_secondary));
                ...
                weekView.setTextColor(getResources().getColor(R.color.design_default_color_on_secondary));
...
//判断是否为夜晚
    private boolean nightOrDay(){
        return time <= Night1 || time >= Night2;
    }
